...
opengothic.events.register("onWorldLoaded", function()
    ...
    test.assert_type(world.findNearestItem, "function", "world:findNearestItem primitive exists")
    local nearestItem = world:findNearestItem(player, 5000)
    test.assert_true(nearestItem == nil or opengothic.core.isItem(nearestItem), "findNearestItem returns nil or Item")
    ...
    test.assert_type(world.detectItemsInRange, "function", "world:detectItemsInRange primitive exists")
    test.assert_type(world.detectItemsNear, "function", "world:detectItemsNear primitive exists")
    ...
    local nearbyItems = world:detectItemsInRange(px, py, pz, 5000)
    test.assert_type(nearbyItems, "table", "world:detectItemsInRange returns table")
    local nearItems = world:detectItemsNear(player, 5000)
